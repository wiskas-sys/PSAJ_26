...
import { products, getProducts, setStoredProducts, stockStatus } from '@/lib/demo-data';
...
export function MovementForm({ type }) {
    ...
    useEffect(() => { setCatalog(getProducts()); setProduct(getProducts()[0]); }, []);
